  ...
  return (
    <div className="mx-auto flex min-h-full max-w-5xl flex-col justify-center px-4 py-12">
      <div className="mb-10 max-w-3xl">
        <div className="mb-5 inline-flex items-center gap-2 border border-primary/25 bg-primary/10 px-3 py-1.5 text-sm font-semibold text-primary">
      ...
      <div className="mt-6 grid gap-3 md:grid-cols-2">
        {examples.map((example) => (
          <button
            ...
            className="min-h-20 border border-ink/10 bg-white/75 px-4 py-4 text-left text-[15px] leading-6 text-ink transition hover:-translate-y-0.5 hover:border-primary/35 hover:bg-white focus:outline-none focus:ring-2 focus:ring-primary/35"
          >
            {example}
          </button>
        ))}
