    ...
    >
      <div
        className={cn(
          ...
          status === "running" && "border-accent/45 bg-accent/15 text-ink",
          status === "success" && "border-primary/25 bg-primary/10 text-ink",
          ...
          >
            <defs>
              <marker
                ...
                refY="4"
              >
                <path d="M0 0 L8 4 L0 8 Z" fill="rgba(15,23,42,0.58)" />
              </marker>
            </defs>
            {connectors.map((path) => (
              <path
